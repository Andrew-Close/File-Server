 ...
 */
public class IDMap {
    public final HashMap<Integer, String> idMap = new HashMap<>();
     ...
     */
    synchronized public void addPair(String filename) {
     ...
     */
    synchronized public String getByID(int id) {
        return idMap.get(id);
    }
     ...
     */
    synchronized public int getIDByName(String filename) {
     ...
     */
    synchronized public void deleteByName(String filename) {
        for (Map.Entry<Integer, String> entry : idMap.entrySet()) {
            if (entry.getValue().equals(filename)) {
     ...
     */
    synchronized public int getLeastAvailableID() {
